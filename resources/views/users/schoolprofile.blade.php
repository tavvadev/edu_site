...
<h1 class="display-5 text-center fw-bold title-clr text-capitalize mb-5">
    ...
    @if ($errors->any())
        <div class="alert alert-danger">
            <h2 class="fw-normal text-body py-4 text-center"><span class="fw-bold">Whoops!</span>
   ...
   <div class="col-md-6">
    ...
    @csrf
         <div class="row">
            ...
            <div class="col-md-12">
                <h2 class="fs-5 fw-bold pt-4 pb-2 mb-0 text-start">School Details</h2>
            <div class="form-group  pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">School ID </label>
                    <div class="col-md-6 d-flex align-items-center">
                        {{$schoolDetails['UDISE_code']}}
                    </div>
                </div>
                <div class="form-group  pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">School Name </label>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="form-group  pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">School Category *</label>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <h2 class="fs-5 fw-bold pt-4 pb-2 mb-0 text-start">Staff Details</h2>
                <div class="form-group  pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">Head Master Name *</label>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="form-group  pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">Head Master Contact Number *</label>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="form-group  pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">Alternate Person Name </label>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="form-group  pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">Alternative Person Contact Number </label>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="form-group pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">No of Teachers *</label>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="form-group pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">No Of Students *</label>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="form-group  pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">Girls *</label>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="form-group pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">Boys *</label>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="form-group pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">No Of  Class rooms *</label>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="form-group  pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">School Address </label>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="form-group  pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">PIN Code </label>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <p class="pb-0 pt-4 fs-5 text-body fw-normal text-body">
                </p>

                  <h2 class="fs-5 fw-bold pt-4 pb-2 mb-0 text-start">   School Location</h2>

                <div class="form-group  pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">latitude *</label>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="form-group border-bottom pb-3 pt-3 d-flex align-items-center justify-content-between mb-2">
                    <label class="fw-normal text-body col-md-6">longitude *</label>
                    <div class="col-md-6 d-flex align-items-center">
